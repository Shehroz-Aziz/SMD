...
public class AddingNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adding_new);
        init();
        ...
        btnEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               {
                   Toast.makeText(AddingNewActivity.this, "Fill All Feilds", Toast.LENGTH_SHORT).show();
               }
               ...
               {
                   Toast.makeText(AddingNewActivity.this, "Wrong Ratings Input", Toast.LENGTH_SHORT).show();
               }
               else
               {
                   ...
                   editor.apply();
                   Intent intent = new Intent(AddingNewActivity.this, MainActivity.class);
    ...
    public  void init()
    {
        des=findViewById(R.id.tvResDescription);
        location=findViewById(R.id.tvResLocation);
        name=findViewById(R.id.tvResName);
        contact=findViewById(R.id.tvResContact);
        rating=findViewById(R.id.tvResRatings);
